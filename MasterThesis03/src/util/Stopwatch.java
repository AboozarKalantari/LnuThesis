...
public class Stopwatch {
	...
	private enum Status {start, run, pause, stop; };
	...
	/**
	 * Start to time. <br>
	 * An alternative method of <em>start</em>().
	 */
	...
	/**
	 * Get the time interval. <br>
	 * An alternative method of <em>runtime</em>().
	 */
